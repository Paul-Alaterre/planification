...
public class DemoBruteForce {
	...
	public static void main(String[] args) {
		...
		List<Activity> premierTriFini = premierTri.bruteForceSort(firstActivities, firstConstraints);
		...
		Map<Activity, Integer> schedule = premierTri.schedule(firstActivities, firstConstraints, 20);
		...
		List<Activity> secondTriFini = premierTri.bruteForceSort(secondActivities, secondConstraints);
